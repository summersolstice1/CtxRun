...
`ctxrun-plugin-transfer:allow-get-chat-history`

</td>
<td>

Enables the get_chat_history command without any pre-configured scope.
...
`ctxrun-plugin-transfer:deny-get-chat-history`

</td>
<td>

Denies the get_chat_history command without any pre-configured scope.
...
`ctxrun-plugin-transfer:allow-get-devices`
...
`ctxrun-plugin-transfer:deny-get-devices`
...
`ctxrun-plugin-transfer:allow-get-network-interfaces`
...
`ctxrun-plugin-transfer:deny-get-network-interfaces`
...
`ctxrun-plugin-transfer:deny-send-file`
...
`ctxrun-plugin-transfer:allow-send-message`
...
`ctxrun-plugin-transfer:deny-send-message`
...
`ctxrun-plugin-transfer:allow-start-service`
...
`ctxrun-plugin-transfer:deny-start-service`
...
`ctxrun-plugin-transfer:allow-stop-service`
...
`ctxrun-plugin-transfer:deny-stop-service`
