...
mod tests {
    ...
    #[test]
    fn test_fix_multiline_links() {
        let input = "[This is a\nlong link](https://example.com)";
        let expected = "[This is a\\\nlong link](https://example.com)";
        assert_eq!(fix_multiline_links(input), expected);
    }

    #[test]
    fn test_fix_nested_brackets() {
        let input = "[[nested\ntext]](url)";
        let expected = "[[nested\\\ntext]](url)";
        assert_eq!(fix_multiline_links(input), expected);
    }
    ...
    fn test_remove_skip_to_content() {
        ...
        let expected = "\n\nActual content here.";
        assert_eq!(remove_skip_to_content_links(input), expected);
    }

    #[test]
    fn test_remove_skip_case_insensitive() {
    ...
    #[test]
    fn test_preserve_normal_links() {
        let input = "[Normal Link](#section)\n[Skip to Main Content](#main)";
        let output = remove_skip_to_content_links(input);
        assert!(output.contains("[Normal Link](#section)"));
        assert!(!output.contains("Skip to Main Content"));
    }
