...
const translations = {
  en: {
    ...
    transfer: {
      ...
      route: "Route",
      linkMode: "Link mode",
      randomLink: "Random route",
      fixedLink: "Fixed route",
      secureLocal: "Local-only session",
      ...
      sidebarIdleTitle: "Service offline",
      sidebarIdleBody: "Start the service to create a nearby transfer link and QR code.",
      sidebarWaitingTitle: "Waiting for nearby devices",
      sidebarWaitingBody: "Open the connection panel, scan the QR code, or copy the link to join from your phone.",
      selectDevice: "Select a device to start chatting.",
      emptyChat: "Send a message or share a file to start this session.",
      workspaceIdleTitle: "Start a local session",
      workspaceIdleBody: "Launch the service to open a nearby chat and file relay.",
      workspaceWaitingTitle: "Session is live",
      workspaceWaitingBody: "Your active device and transfer timeline will appear here as soon as it joins.",
      connectedSince: "Connected {{time}}",
    ...
    context: {
      ...
      scanFail: "Scan failed. Check the selected path and permissions.",
      securityScanFallback: "Security scan failed. Proceeding without redaction.",
    ...
    patch: {
      ...
      gitTip: "The current workspace is used as the repository target. Manual Comparison is still available for pasted content.",
    ...
    spotlight: {
      ...
      toolInlineTool: "Tool",
      toolInlineShell: "Shell",
      toolInlineFsList: "List",
      toolInlineFsSearch: "Search",
      toolInlineFsRead: "Read",
      toolInlineWebSearch: "Web",
      toolInlineWebExtract: "Extract",
      toolInlineArgs: "Arguments",
      toolInlineOutput: "Output",
      toolInlineCommand: "Command",
      resizeModeToggle: "Resize",
      resizeModeActive: "Resize Mode",
      resizeModeSize: "Size",
      resizeModeAdjust: "Resize",
      resizeModeAccelerate: "Fast",
      resizeModeReset: "Reset",
      resizeModeSave: "Save",
      resizeModeCancel: "Cancel",
      execApprovalRequired: "Approval required",
      execWorkingDirectory: "Working directory",
      execCommand: "Command",
      execTerminate: "Stop",
      execApproveTitle: "Approve command execution",
      execParsedCommands: "Parsed commands",
      execPrefixAllowRule: "Prefix allow rule",
      execPrefixRuleAvailable: "Prefix rule available",
      execReviewDetails: "Review details",
      execApprovalHint: "This command needs manual confirmation before the agent can continue. Review the command and working directory first.",
      execApprovalFootnote: "Approval pauses the current agent turn until you decide.",
      execRiskMedium: "Review",
      execRiskHigh: "High risk",
      execEscCancel: "Esc to cancel",
      execDeny: "Deny",
      execRejectBack: "Back",
      execRejectNotePlaceholder: "Tell AI what to do instead...",
    ...
    topbar: {
      ...
      moveHint: "Move toward a module",
      clickHint: "Click to switch",
      releaseHint: "Release Alt to switch",
    ...
    monitor: {
      ...
      powerOverview: "Battery & Power",
      batteryHealth: "Battery Health",
      batteryHealthValue: "Health {{value}}%",
      batteryUnavailable: "Unavailable",
      noBatteryDetected: "No battery detected on this device.",
      batteryTimeRemaining: "Time Remaining",
      batteryTimeToFull: "Time to Full",
      batteryTimeHoursMinutes: "{{hours}}h {{minutes}}m",
      batteryTimeHours: "{{hours}}h",
      batteryTimeMinutes: "{{minutes}}m",
      batteryVoltage: "Voltage",
      batteryCapacity: "Capacity",
      batteryCycles: "Cycles",
      batteryPackCount: "{{count}} packs",
      batteryStateCharging: "Charging",
      batteryStateDischarging: "Discharging",
      batteryStateFull: "Full",
      batteryStateEmpty: "Empty",
      ...
      diskOverview: "Disks",
      noDiskData: "No disk data available.",
      ...
      showAllAdapters: "Show all adapters ({{count}})",
      hideAllAdapters: "Hide all adapters",
      adapterPrimary: "Primary",
      adapterVirtual: "Virtual",
      adapterActive: "Active",
      adapterStatusConnected: "Connected",
      adapterStatusDisconnected: "Disconnected",
      adapterStatusTesting: "Testing",
      adapterStatusDormant: "Dormant",
      adapterStatusNotPresent: "Not present",
      adapterStatusLowerLayerDown: "Lower layer down",
      adapterStatusUnknown: "Unknown",
      adapterTypeWifi: "Wi-Fi",
      adapterTypeEthernet: "Ethernet",
      adapterTypeLoopback: "Loopback",
      adapterTypeTunnel: "Tunnel",
      adapterTypeOther: "Other",
      networkDownload: "Download",
      networkUpload: "Upload",
      networkTotalReceived: "Total In",
      networkTotalTransmitted: "Total Out",
      networkMac: "MAC",
      networkGateway: "Gateway",
      networkType: "Type",
      networkMtu: "MTU",
      networkNoAddress: "No address",
      ...
      killFailedWithReason: "Failed to kill process: {{reason}}",
      refresh: "Refresh",
      ...
      netSummary: "Network Health",
      netSummaryCounts: "{{healthy}} healthy · {{degraded}} degraded · {{offline}} offline",
      netSpeedTest: "Public Speed Test",
      netSpeedRunning: "Running Test...",
      netRunSpeedTest: "Run Speed Test",
      netPing: "Ping Quality",
      netServer: "Server",
      netPhase: "Phase",
      netLastCompleted: "Last Completed",
      netRealtimeChart: "Real-time Throughput",
      netDownload: "Download",
      netUpload: "Upload",
      netPending: "Pending",
      netUnavailable: "Unavailable",
      netProbeTarget: "Probe Target",
      netCustomTargetPlaceholder: "e.g. api.openai.com or https://registry.npmmirror.com/-/ping",
      netCustomTargetProbe: "Probe Target",
      netCustomTargetRunning: "Probing...",
      netCustomTargetRequired: "Enter an HTTP or HTTPS target before running a custom probe.",
      netDetailedProbes: "Detailed Probes",
      netDns: "DNS",
      netTcp: "TCP",
      netHttp: "HTTP",
      netObservations: "Observations",
      netNoObservations: "No anomalies",
      netHealthy: "Healthy",
      netDegraded: "Degraded",
      netOffline: "Offline",
      netConsentTitle: "Allow M-Lab public measurement",
      netConsentBody: "The throughput test uses Measurement Lab infrastructure and may submit measurement metadata such as IP and performance results.",
      netConsentRequired: "Accept the M-Lab data policy before starting the public speed test.",
      netPolicyLink: "Review data policy",
      netPhaseIdle: "Ready",
      netPhaseDiscovering: "Choosing server",
      netPhaseDownload: "Downloading",
      netPhaseUpload: "Uploading",
      netPhaseComplete: "Completed",
      netPhaseError: "Failed",
      netObservationDnsFailed: "DNS failed",
      netObservationDnsSlow: "Slow DNS",
      netObservationTcpFailed: "TCP failed",
      netObservationTcpSlow: "Slow TCP",
      netObservationHttpFailed: "HTTP failed",
      netObservationHttpStatus: "HTTP status",
      netObservationHttpSlow: "Slow HTTP",
      netObservationInvalidTarget: "Invalid target",
      netObservationGeneric: "Observation",
      // Git
    }
  },
  zh: {
    ...
    transfer: {
      ...
      noDevices: "暂时还没有设备连接。",
      sidebarIdleTitle: "服务尚未开启",
      sidebarIdleBody: "开启服务后会生成局域网链接和二维码。",
      sidebarWaitingTitle: "等待附近设备加入",
      sidebarWaitingBody: "展开连接面板后扫描二维码，或直接复制链接到手机端访问。",
      selectDevice: "选择一个设备开始聊天。",
      emptyChat: "发送消息或共享文件来开始本次会话。",
      workspaceIdleTitle: "开启本地会话",
      workspaceIdleBody: "启动服务后，这里会变成附近设备的聊天与文件传输工作区。",
      workspaceWaitingTitle: "会话已启动",
      workspaceWaitingBody: "设备加入后，这里会显示实时聊天记录和文件传输进度。",
      connectedSince: "{{time}} 已连接",
    ...
    context: {
      ...
      scanFail: "扫描失败，请检查所选路径和权限",
      securityScanFallback: "安全扫描失败，将跳过脱敏继续执行",
    ...
    patch: {
      ...
      comparing: "对比中...",
      generateDiff: "对比差异",
      gitTip: "当前工作区会作为仓库目标使用，你仍然可以通过「对比」进行手动内容比较",
      binaryFile: "二进制文件",
      largeFile: "大文件",
      export: "导出",
      exportSuccess: "导出成功！",
    ...
    spotlight: {
      ...
      toolInlineShell: "命令",
      toolInlineFsList: "目录",
      toolInlineFsSearch: "搜索",
      toolInlineFsRead: "读取",
      toolInlineWebSearch: "网页",
      toolInlineWebExtract: "提取",
      toolInlineArgs: "参数",
      toolInlineOutput: "输出",
      toolInlineCommand: "命令",
      resizeModeToggle: "调整尺寸",
      resizeModeActive: "尺寸调整",
      resizeModeSize: "尺寸",
      resizeModeAdjust: "调整",
      resizeModeAccelerate: "加速",
      resizeModeReset: "重置",
      resizeModeSave: "保存",
      resizeModeCancel: "取消",
      execApprovalRequired: "等待审批",
      execWorkingDirectory: "工作目录",
      execCommand: "命令",
      execTerminate: "急停",
      execApproveTitle: "批准执行命令",
      execParsedCommands: "解析后的命令",
      execPrefixAllowRule: "前缀放行规则",
      execPrefixRuleAvailable: "可按前缀放行",
      execReviewDetails: "查看详细信息",
      execApprovalHint: "当前命令需要你手动确认后，AI 才会继续执行。请先检查命令内容和工作目录。",
      execApprovalFootnote: "审批期间，当前这轮 agent 执行会暂停等待你的决定。",
      execRiskMedium: "需审查",
      execRiskHigh: "高风险",
      execEscCancel: "按 Esc 取消",
      execDeny: "拒绝",
      execRejectBack: "返回",
      execRejectNotePlaceholder: "告诉 AI 改做什么...",
      execAllowOnce: "允许一次",
    ...
    monitor: {
      ...
      powerOverview: "电池与供电",
      batteryHealth: "电池健康",
      batteryHealthValue: "健康度 {{value}}%",
      batteryUnavailable: "不可用",
      noBatteryDetected: "当前设备未检测到电池。",
      batteryTimeRemaining: "剩余时间",
      batteryTimeToFull: "充满时间",
      batteryTimeHoursMinutes: "{{hours}}小时 {{minutes}}分钟",
      batteryTimeHours: "{{hours}}小时",
      batteryTimeMinutes: "{{minutes}}分钟",
      batteryVoltage: "电压",
      batteryCapacity: "容量",
      batteryCycles: "循环次数",
      batteryPackCount: "{{count}} 组电池",
      batteryStateCharging: "充电中",
      batteryStateDischarging: "放电中",
      batteryStateFull: "已充满",
      batteryStateEmpty: "电量耗尽",
      batteryStateUnknown: "未知",
      systemSummary: "系统摘要",
      systemHost: "主机名",
      systemOs: "系统版本",
      systemKernel: "内核版本",
      ...
      diskTypeSSD: "固态硬盘",
      diskTypeHDD: "机械硬盘",
      diskTypeUnknown: "未知类型",
      networkInterfaces: "网络接口",
      noNetworkInterfaces: "未检测到网络接口。",
      allAdapters: "全部适配器",
      showAllAdapters: "显示全部适配器 ({{count}})",
      hideAllAdapters: "收起全部适配器",
      adapterPrimary: "主接口",
      adapterVirtual: "虚拟接口",
      adapterActive: "有流量",
      adapterStatusConnected: "已连接",
      adapterStatusDisconnected: "已断开",
      adapterStatusTesting: "测试中",
      adapterStatusDormant: "休眠中",
      adapterStatusNotPresent: "未就绪",
      adapterStatusLowerLayerDown: "底层未连接",
      adapterStatusUnknown: "未知",
      adapterTypeWifi: "无线网络",
      adapterTypeEthernet: "以太网",
      adapterTypeLoopback: "回环接口",
      adapterTypeTunnel: "隧道接口",
      adapterTypeOther: "其他",
      networkDownload: "下载",
      networkUpload: "上传",
      networkTotalReceived: "累计接收",
      networkTotalTransmitted: "累计发送",
      networkMac: "MAC",
      networkGateway: "默认网关",
      networkType: "接口类型",
      networkMtu: "MTU",
      networkNoAddress: "无地址信息",
      topProcesses: "Top 进程",
      procName: "名称",
      procPid: "PID",
      procCpu: "CPU%",
      ...
      killSuccess: "进程已结束",
      killFailed: "结束进程失败",
      killFailedWithReason: "结束进程失败：{{reason}}",
      refresh: "刷新",
      systemPort: "系统端口",
      protected: "受保护的系统进程",
      checkLocks: "检测占用",
      ...
      diagnosing: "诊断中...",
      netSummary: "网络健康度",
      netSummaryCounts: "{{healthy}} 正常 · {{degraded}} 降级 · {{offline}} 离线",
      netSpeedTest: "公网测速",
      netSpeedRunning: "测速进行中...",
      netRunSpeedTest: "开始测速",
      netPing: "Ping 质量",
      netServer: "测速节点",
      netPhase: "阶段",
      netLastCompleted: "最近完成",
      netRealtimeChart: "实时吞吐曲线",
      netDownload: "下载",
      netUpload: "上传",
      netPending: "等待中",
      netUnavailable: "不可用",
      netProbeTarget: "探测目标",
      netCustomTargetPlaceholder: "例如 api.openai.com 或 https://registry.npmmirror.com/-/ping",
      netCustomTargetProbe: "探测目标",
      netCustomTargetRunning: "探测中...",
      netCustomTargetRequired: "运行自定义探测前，请先输入 HTTP 或 HTTPS 目标。",
      netDetailedProbes: "诊断明细",
      netDns: "DNS",
      netTcp: "TCP",
      netHttp: "HTTP",
      netObservations: "观察项",
      netNoObservations: "未发现异常",
      netHealthy: "正常",
      netDegraded: "降级",
      netOffline: "离线",
      netConsentTitle: "允许使用 M-Lab 公网测量",
      netConsentBody: "公网测速会使用 Measurement Lab 基础设施，并可能提交包含 IP 与性能结果在内的测量元数据。",
      netConsentRequired: "开始公网测速前，请先接受 M-Lab 数据政策。",
      netPolicyLink: "查看数据政策",
      netPhaseIdle: "就绪",
      netPhaseDiscovering: "选择节点中",
      netPhaseDownload: "下载中",
      netPhaseUpload: "上传中",
      netPhaseComplete: "已完成",
      netPhaseError: "失败",
      netObservationDnsFailed: "DNS 失败",
      netObservationDnsSlow: "DNS 偏慢",
      netObservationTcpFailed: "TCP 失败",
      netObservationTcpSlow: "TCP 偏慢",
      netObservationHttpFailed: "HTTP 失败",
      netObservationHttpStatus: "HTTP 状态异常",
      netObservationHttpSlow: "HTTP 偏慢",
      netObservationInvalidTarget: "目标无效",
      netObservationGeneric: "观察项",
    }
  }
};
