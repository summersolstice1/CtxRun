...
const translations = {
  en: {
    ...
    settings: {
      ...
      mcpTitle: "MCP HTTP Service",
      mcpDesc: "Expose Miner tools to Claude through local HTTP MCP endpoint.",
      mcpEnabled: "Enable MCP Service",
      mcpEnabledDesc: "Turn on/off local MCP HTTP service immediately.",
      mcpAutoStart: "Start With App",
      mcpAutoStartDesc: "Automatically apply MCP start/stop when app launches.",
      mcpStatus: "Current Status",
      mcpStatusRunning: "Running",
      mcpStatusStopped: "Stopped",
      mcpEndpoint: "Endpoint",
      mcpAuthEnabled: "Auth: Enabled (token required)",
      mcpAuthDisabled: "Auth: Disabled",
      mcpHost: "Host",
      mcpPort: "Port",
      mcpToken: "Token",
      mcpTokenTip: "Leave empty to disable token auth.",
      mcpSaveConfig: "Save Connection Settings",
      mcpConfigSaved: "MCP settings saved.",
      mcpInvalidHost: "Host cannot be empty.",
      mcpInvalidPort: "Port must be an integer between 1 and 65535.",
      mcpStartNow: "Start Now",
      mcpStopNow: "Stop Now",
      mcpRefreshStatus: "Refresh",
      mcpActionFailed: "MCP action failed: {error}"
    },
    library: {
  ...
  zh: {
    ...
    settings: {
      ...
      mcpTitle: "MCP HTTP 服务",
      mcpDesc: "通过本地 HTTP MCP 端点把 Miner 工具暴露给 Claude。",
      mcpEnabled: "启用 MCP 服务",
      mcpEnabledDesc: "立即开启/关闭本地 MCP HTTP 服务。",
      mcpAutoStart: "随应用启动",
      mcpAutoStartDesc: "应用启动时自动应用 MCP 启停状态。",
      mcpStatus: "当前状态",
      mcpStatusRunning: "运行中",
      mcpStatusStopped: "已停止",
      mcpEndpoint: "端点",
      mcpAuthEnabled: "鉴权：已开启（需要 Token）",
      mcpAuthDisabled: "鉴权：未开启",
      mcpHost: "主机",
      mcpPort: "端口",
      mcpToken: "Token",
      mcpTokenTip: "留空表示关闭 Token 鉴权。",
      mcpSaveConfig: "保存连接设置",
      mcpConfigSaved: "MCP 设置已保存。",
      mcpInvalidHost: "主机地址不能为空。",
      mcpInvalidPort: "端口必须是 1 到 65535 的整数。",
      mcpStartNow: "立即启动",
      mcpStopNow: "立即停止",
      mcpRefreshStatus: "刷新",
      mcpActionFailed: "MCP 操作失败：{error}"
    },
    library: {
      title: "官方指令库",
